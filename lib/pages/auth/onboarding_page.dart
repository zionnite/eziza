...
const _slides = [
  _Slide(
    ...
    title: 'Send Anything,\nAnywhere,\nFast',
    subtitle:
        'Request a pickup in seconds and get matched with a nearby rider or logistics company.',
  ...
  _Slide(
    ...
    title: 'Watch Your\nPackage\nMove Live',
    subtitle:
        'Track your rider on the map from pickup to drop-off, with status updates every step of the way.',
...
class _OnboardingPageState extends State<OnboardingPage>
  ...
  void initState() {
    ...
    _scaleA = Tween<double>(
      begin: 1.06,
      end: 1.0,
    ).animate(CurvedAnimation(parent: _entrance, curve: Curves.easeOutCubic));
    _floatA = Tween<double>(
      begin: 0,
      end: 10,
      ...
      body: Stack(
        children: [
          ...
          Container(
            decoration: BoxDecoration(
              gradient: RadialGradient(
                ...
                colors: [
                  Colors.transparent,
                  EzizaColors.kNavy.withValues(alpha: 0.55),
                ],
              ),
            ),
          ),
          ...
          AnimatedBuilder(
            animation: _floatA,
            builder: (_, _) =>
                _Orbs(slide: slide, size: size, float: _floatA.value),
          ),
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                gradient: LinearGradient(
                                  colors: [
                                    slide.accent,
                                    slide.accent == EzizaColors.kGold
                                        ? const Color(0xFFFF9500)
                                        : const Color(0xFF0096B4),
                                  ],
                                  begin: Alignment.topLeft,
                                  end: Alignment.bottomRight,
                                ),
